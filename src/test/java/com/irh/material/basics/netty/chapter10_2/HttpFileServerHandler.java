...
public class HttpFileServerHandler extends SimpleChannelInboundHandler<FullHttpRequest> {
    ...
    private void sendListing(ChannelHandlerContext ctx, File dir) {
        ...
        buf.append("</h3>\r\n");
        buf.append("<ul>)");
        buf.append("<li>链接：<a href=\"http://www.baidu.com/\">进入百度</a></li>\r\n");
    ...
    private String sanitizeUri(String uri) {
        ...
        if (uri.contains(File.separator + ".") || uri.contains('.' + File.separator) || uri.endsWith(".") || INSECURE_URI.matcher(uri).matches()) {
            return null;
        }
